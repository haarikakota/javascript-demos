function findAll(match,arr){
    ...
    for(let v of arr){
		...
		else if(match == undefined && v == undefined){
			ret.push(v);
		}
		...
		else if(typeof(match) == 'number' && !Object.is(match,NaN) && !Object.is(match,Infinity) && !Object.is(match,-Infinity) && typeof(v) =='string' && v.trim() !== ""){
			if(match == v){
			ret.push(v);
		}
		}
		else if(Object.is(match,-0) && Object.is(v,"0")){
